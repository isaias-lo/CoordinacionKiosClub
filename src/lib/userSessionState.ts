...
type Fuente = 'regiones' | 'santiago' | 'guides' | 'rutas' | 'rutas_v2' | 'segunda_vuelta' | 'rutas_reg' | 'rutas_cerradas' | 'rutas_cerradas_cong' | 'flota_sel' | 'flota_sel_cong' | 'congelados-santiago' | 'congelados-regiones' | 'rutas_congelados' | 'planificador';
