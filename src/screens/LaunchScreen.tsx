...
export function LaunchScreen() {
  ...
  /* Quick tiles — sub-rutas se ocultan si el hub padre es accesible */
  const hasDespachoHub    = canSee('/despacho-hub');
  ...
  const potentialTiles: (QuickTile | null)[] = [
    ...
    // Solo mostrar si el usuario NO tiene acceso al hub de despacho (evita duplicar)
    !hasDespachoHub && canSee('/despacho/regiones') ? {
    ...
    !hasDespachoHub && canSee('/despacho/santiago') ? {
