...
export type UserRole = 'auditor' | 'admin-auditoria' | 'despachador' | 'admin' | 'recepcion-tienda' | 'supervisor-picking' | 'asistente-despacho' | 'coordinador-flota' | 'supervisor' | 'conductor' | (string & {});
