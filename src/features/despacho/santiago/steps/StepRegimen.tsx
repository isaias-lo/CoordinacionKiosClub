      ...
      <div className="flex flex-col gap-4 w-full max-w-sm">
        {OPCIONES.map(({ value, emoji, desc }) => (
          <button
            ...
            <div>
              <div className={`font-barlow-condensed text-[26px] font-extrabold tracking-wide leading-tight ${mounted && state.regimen === value ? 'text-info' : 'text-navy'}`}>
                {value.toUpperCase()}
              </div>
