...
export const TIENDAS_SANTIAGO: TiendaSantiago[] = [
  ...
  { region:'RM', tienda:'PIE ANDINO',              cod:'14PIE', direccion:'Av. Paseo Pie Andino 5855 Local 3A Lo Barnechea',         comuna:'Lo Barnechea',  tipo:'STRIPCENTER', ventanaHoraria:'9:00 - 12:00',  diasDespacho:['MA','MI','VI'] },
