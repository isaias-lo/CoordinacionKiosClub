...
export const TIENDAS_SANTIAGO: TiendaSantiago[] = [
  ...
  // ── Costa (V Región) ────────────────────────────────────────────────────────
  { region:'VR', tienda:'VIÑA DEL MAR',            cod:'37VIN', direccion:'8 Norte 675, Viña del Mar',                               comuna:'Viña del Mar',  tipo:'STRIPCENTER', ventanaHoraria:'9:30 - 11:30',  diasDespacho:['LU','MI'] },
