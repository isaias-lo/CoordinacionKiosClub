...
export const SENDU_EXTRAS: Record<string, SenduExtra> = {
  ...
  "50PTM": { name:"Puerto Montt",      region:"LOS LAGOS",    nombre_dest:"tienda puerto montt",          email:"puertomontt@kiosclub.com",       celular:"995040635",   rut:"76360868-9", region_sendu:"Los_Lagos",                                       comuna:"Puerto Montt",        calle:"Illapel",               numero:"10",    complemento:"Local 111a",         str_val:"Puerto Montt" },
