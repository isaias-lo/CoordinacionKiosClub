import { tieneCarga } from './pool';

/**
 * Detecta un "fantasma" en el pool del Enrutador: un código que NO está en el catálogo
 * (tiendas) Y que no tiene NINGÚN tipo de carga (pallets, bultos, contenedores ni chocolates).
 *
