...
function fromRuta(ruta: Ruta, idx: number, fecha: string, tiendas: Record<string, TiendaInfo & { _parada?: boolean }>, seq: number = idx, fechaSalida?: string | null): ManifiestoData {
  return {
    ...
    tiendas: ruta.ts.map((t, i) => {
      ...
      return { store_cod: t.c, nombre: info.n, ventana: info.v, observacion: info.observacion, orden: i + 1, pallets: t.p, bultos: t.b, chocolates: ((t as { ch?: number }).ch ?? 0), contenedores: 0 };
    }),
