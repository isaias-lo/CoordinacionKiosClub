...
export const TIENDAS: Record<string, Tienda> = {
  ...
  "Antofagasta (ANP)": {cod:"41ANP",name:"Antofagasta (ANP)", region:"ANTOFAGASTA",   nombre_dest:"tienda La Portada",            email:"paseolaportada@kiosclub.com",   celular:"934031556",rut:"76360868-9",region_sendu:"Antofagasta",                                     comuna:"Antofagasta",         calle:"Av Pedro Aguirre Cerda",                          numero:"10578",complemento:"Local 303-303",  str_val:"Antofagasta"},
  "Antofagasta (ANA)": {cod:"40ANA",name:"Antofagasta (ANA)", region:"ANTOFAGASTA",   nombre_dest:"Tienda Cenco Angamos",         email:"cencoangamos@kiosclub.com",     celular:"976568957",rut:"76360868-9",region_sendu:"Antofagasta",                                     comuna:"Antofagasta",         calle:"Av Angamos",                                      numero:"745",  complemento:"Local 1032",     str_val:"Antofagasta"},
...
export const CALENDARIO: Record<number, string[]> = {
  1: ['39PSB','46TRE','41ANP','40ANA','47PTV','75PUC','28TEM','50PTM','53VAL'],
  2: ['27MCH','36CHL','24SPP','38SP2','76PAN','51SER'],
  3: ['41ANP','40ANA','47PTV','46TRE','39PSB','50PTM','31TLC','53VAL'],
