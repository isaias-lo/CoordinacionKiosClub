  ...
  return (
    <div className="bg-navy px-3 py-3 flex items-center gap-2 flex-shrink-0">
      <button onClick={onBack}
        className="lg:hidden flex items-center justify-center w-8 h-8 text-white/70 text-[20px] cursor-pointer border-none bg-white/10 rounded-full flex-shrink-0 active:bg-white/20">
        ←
      </button>
...
export function StepForm() {
      ...
      {activeTiendasCount > 0 && (
        <div className="px-3 pb-3 pt-1 lg:hidden">
          <button onClick={goToResumen}
            className="w-full py-3 bg-red text-white rounded-btn font-barlow-condensed text-[17px] font-bold cursor-pointer active:bg-red-dark"
  ...
  const renderMultiForm = () => {
    ...
    return (
      <>
        <TiendaFormHeader tienda={currentTienda} pallets={tiendaPallets} bultos={tiendaBultos} onBack={() => setView('list')} />
